        ...
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 text-black">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
                ...
                <form onSubmit={handleLogin}>
                    <div className="mb-4">
                        <label htmlFor="idCnpj" className="block text-gray-700 font-semibold">CNPJ</label>
                        <input 
                            type="text" 
                            id="idCnpj" 
                            value={cnpj} 
                    ...
                    <div className="mt-6 flex flex-col items-center">
                        ...
                        <button 
                            type="submit" 
                            className="w-full py-2 bg-purple-600 text-white font-semibold rounded-md hover:bg-purple-700 transition duration-300">Entrar</button>
                            </Link>
                        <p className="mt-4 text-center">
                            <a href="/cadastro" className="text-purple-600 hover:text-purple-800">Não tem cadastro? Faça clicando aqui</a>
                        </p>
                    </div>
                </form>
            </div>
